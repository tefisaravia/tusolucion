...
function agentpress_property_details_filter( $details ) {
	...
	$details['col1'] = array( 
		__( 'Precio:', 'agentpress' )   => '_listing_precio', 
		__( 'Dormitorio:', 'agentpress' ) => '_listing_dormitorio', 
		__( 'Categoria:', 'agentpress' )    => '_listing_categoria', 
		__( 'Tipo:', 'agentpress' )   => '_listing_tipo', 
		__( 'Zona:', 'agentpress' )     => '_listing_zona',
	);

	$details['col2'] = array( 
		__( 'Metros:', 'agentpress' )       => '_listing_metros', 
		__( 'Estacionamiento:', 'agentpress' ) => '_listing_estacionamiento', 
		__( 'Codigo:', 'agentpress' )    => '_listing_codigo', 
		__( 'Baños:', 'agentpress' )   => '_listing_baños', 
		__( 'Compartido:', 'agentpress' )    => '_listing_compartido',
	);
